from api.views import ContactUsViewSet, RateTypeChoiceView, RateViewSet, SourceListView, api_list_page
...
router.register(r'contactus', ContactUsViewSet, basename='contact')
